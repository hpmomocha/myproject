...
class PasswordChangeTests(TestCase):
    ...
    def test_form_inputs(self):
        ...
        '''
        self.assertContains(self.response, "<input type", 4)
...
class LoginRequiredPasswordChangeTests(TestCase):
    def test_redirection(self):
        ...
        # Python3.6中引入了一种新的字符串格式化的机制，为Literal String Interpolation（即字符串的插值），
        # 或者是一种更为通俗的名称，为F-Strings，因为该字符串格式化是以 f 开头的。
...
class SuccessfulPasswordChangeTests(PasswordChangeTestCase):
    def setUp(self):
        super().setUp({
            ...
            'new_password1': 'new_password123456',
            'new_password2': 'new_password123456',
        })
    ...
    def test_password_changed(self):
        ...
        '''
        self.assertTrue(self.user.check_password('new_password123456'))
...
class InvalidPasswordChangeTests(PasswordChangeTestCase):
    ...
    def test_didnt_change_password(self):
        # refresh_from_db() ⽅法确保我们拥有最新的数据状态。
        # 它强制Django再次查询数据库以更新数据。
        self.user.refresh_from_db()
